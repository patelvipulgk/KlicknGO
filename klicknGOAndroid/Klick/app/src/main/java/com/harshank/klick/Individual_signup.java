 ...
 */
public class Individual_signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.individual_signup_screen);
        initToolbar();
        btnRegister = (Button)findViewById(R.id.btnRegister);
        btnRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent homescreenIntent = new Intent(Individual_signup.this, HomeScreen.class);
                startActivity(homescreenIntent);
                Individual_signup.this.finish();
            }
        });
    }
